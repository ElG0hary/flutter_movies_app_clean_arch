  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) => sl<MovieDetailsBloc>()
        ..add(GetCurrentMovieDetailsEvent(movieId))
        ..add(GetCurrentMovieRecommendationsEvent(movieId)),
...
class MovieDetailContent extends StatelessWidget {
        ...
        case RequestState.loaded:
          return CustomScrollView(
            ...
            slivers: [
                          ...
                          children: [
                            ...
                            Row(
                              children: [
                                ...
                                Text(
                                  ((state.movieDetails?.voteAverage ?? 0) / 2)
                                      .toStringAsFixed(1),
                                  style: const TextStyle(
                                    fontSize: 16.0,
                                    fontWeight: FontWeight.w500,
              ...
              //!don't use const it causes error
              // ignore: prefer_const_constructors
              SliverPadding(
                padding: const EdgeInsets.fromLTRB(16.0, 0.0, 16.0, 24.0),
                sliver: _showMovieRecommendations(),
              ),
            ],
          );
  ...
  String _showGenres(List<MovieGenres> genres) {
    String result = '';
                ...
                onTap: () => Navigator.pushReplacement(
                  ...
                  MaterialPageRoute(
                    builder: (context) => MovieDetailScreen(
                        movieId: state.movieRecommendations![index].movieId),
                  ),
                ),
                child: FadeInUp(
                  from: 20,
